...
const experiences: Experience[] = [
  {
    ...
    date: 'March 2025',
    points: [
      'Built MohammediaHub, a multilingual (🇫🇷 🇲🇦 🇬🇧) web platform to enhance communication between the municipality and citizens',
      'Developed core features including complaint management, event announcements, surveys, and public information modules',
      'Used TypeScript with ReactJS, Tailwind CSS, and i18next to create a scalable, responsive user interface',
      'Implemented the admin dashboard using Express.js, MongoDB, and JWT for secure role-based access',
    ],
  },
];
